...
export const publicRoutes=['/','/services','/portfolio','/packages','/about','/contact','/faq','/get-started','/privacy-policy','/terms-and-conditions','/refund-cancellation-policy','/cookie-policy'];
