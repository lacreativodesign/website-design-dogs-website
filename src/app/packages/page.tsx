...
export default function PackagesPage() {
  return <>
    <JsonLd data={{ "@context": "https://schema.org", "@type": "OfferCatalog", name: "Website Design Packages", itemListElement: websitePackages.map((pkg) => ({ "@type": "Offer", name: pkg.name, price: pkg.price.replace("$", "").replace(",", ""), priceCurrency: "USD", url: "/packages" })) }} />
    <PackagesViewTracker />
