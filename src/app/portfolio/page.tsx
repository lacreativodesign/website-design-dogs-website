          ...
          <PortfolioFilter
            heading={
              <NumberedSectionHeading
                ...
                description="Explore layout direction through twenty concepts, each with its own brand system, page architecture, original copy, responsive behavior, and coordinated AI-generated imagery."
              />
            }
          />
        </Container>
