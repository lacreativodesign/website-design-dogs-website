...
export default function Error({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <section className="grid min-h-screen place-items-center bg-[var(--color-background)] px-6 text-[var(--color-foreground)]" aria-labelledby="error-page-title">
      <div className="max-w-xl rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-surface)] p-8 text-center shadow-[var(--shadow-md)]">
        ...
        <h1 id="error-page-title" className="mt-3 text-3xl font-black">Something went wrong.</h1>
